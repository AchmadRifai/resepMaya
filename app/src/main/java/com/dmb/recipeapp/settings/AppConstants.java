package com.dmb.recipeapp.settings;


/**
 * This class holds all application constants.
 * 
 * @author |dmb TEAM|
 * 
 */
public class AppConstants {
    ...
    /**
     * Admob Advertisement refresh interval
     */
    public static final int ADMOB_REFRESH_INTERVAL = 60;

    /**
     * Link to the application picture
     */
    ...
    // About Page Strings
    public static final String USER_BLOG_TITLE = "Resep Masakan Jawa Berbasis Android";
	public static final String USER_WEBSITE_URL = "www.maya.com";
	public static final String USER_MAIL = "support@dmb-team.com";
	public static final String USER_PHONE = "+44 888 55 55 55";
	
	public static final String FACEBOOK_URL = "http://facebook.com/says.amel";
	public static final String TWITTER_URL = "http://twitter.com";
	
	// Name of Favorites category
	public static final String CATEGORY_FAVORITE = "MAKANAN";
}
